    ...
    return(
        <section id="inicio" className="w-full max-w-7xl mx-auto md:flex md:items-center md:justify-between mt-24 sm:mt-32 md:mt-0 px-4 sm:px-6 md:px-12 lg:px-16 overflow-hidden">
            ...
            <div className="w-full md:w-[50%] mt-8 md:mt-0 mb-4 md:flex justify-center items-center">
                <img className={`opacity-[87%] h-64 sm:h-80 md:h-96 lg:h-[30rem] w-auto object-contain mx-auto md:mx-0 transform transition-all duration-1000 ${rotate ? "rotate-[4deg]" : "-rotate-[4deg]"}`} src="./icono-destellos.png" alt="Lord Found" />
