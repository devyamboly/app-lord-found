...
export default function FooterSection(){
    ...
    return(
        <footer className="bg-slate-950 pt-14 sm:pt-16 px-5 sm:px-6 md:px-16">
            
            <div className="border-t border-l border-r rounded-t-3xl sm:rounded-t-4xl border-gray-700 pb-10 sm:pb-12">
                <div className="pt-10 sm:pt-12 px-4 sm:px-8 border-b border-gray-700 pb-10 sm:pb-12">
                    <div className="flex flex-col md:flex-row md:justify-between md:items-start w-full space-y-8 md:space-y-0 md:space-x-8">
                        <div className="flex flex-col md:block justify-center md:justify-start items-center md:items-start pb-4 w-full md:w-[40%] md:mr-4 mx-auto">
                            <img className="w-48 sm:w-56 md:w-[75%] mx-auto md:mx-0" src="/logo-4-versiones_Mesa-de-trabajo-1-copia-scaled-e1755857831135-2048x457.png" alt="Logo" />
                            <div className="">
                                <div className="pt-4 md:pl-14 space-x-6 flex items-center justify-center md:justify-start text-center">
                                ...
                                <p className="text-gray-200 text-xs text-center pt-4 md:mr-24 hidden md:block">© {year} LordFound. Todos los derechos reservados.</p>
                            </div>
                        </div>

                        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 w-full justify-between mt-2 pl-6 md:mt-0">
                            <div>
                            ...
                            {/* <div>
                                <h3 className="text-slate-200 uppercase tracking-wide text-xs md:text-sm font-semibold">Programas</h3>
                                <ul className="text-slate-300 space-y-2 mt-4">
                                    <li>
                                        <a className=" hover:text-amber-500 hover:border-b hover:border-amber-500 transition ease-in-out duration-300" href="#">Cómo funciona</a>
                                    </li>
                                    <li>
                                        <a className="hover:text-amber-500 hover:border-b hover:border-amber-500 transition ease-in-out duration-300" href="#">Una fase</a>
                                    </li>
                                    <li>
                                        <a className="hover:text-amber-500 hover:border-b hover:border-amber-500 transition ease-in-out duration-300" href="#">Dos fases</a>
                                    </li>
                                    <li>
                                        <a className="hover:text-amber-500 hover:border-b hover:border-amber-500 transition ease-in-out duration-300" href="#">Tres fases</a>
                                    </li>
                                    <li>
                                        <a className="hover:text-amber-500 hover:border-b hover:border-amber-500 transition ease-in-out duration-300" href="#">Financiación Instantánea</a>
                                    </li>
                                    <li>
                                        <a className="hover:text-amber-500 hover:border-b hover:border-amber-500 transition ease-in-out duration-300" href="#">Desafío Relámpago</a>
                                    </li>
                                </ul>
                            </div> */}
