          ...
          {letters.map(({ letter, word, color }, index) => (
            ...
            >
              <div className="relative overflow-hidden flex items-center justify-start md:justify-center w-full h-full min-w-0">
                ...
                <h3
                  className={`font-extrabold text-[clamp(1.25rem,6vw,1.75rem)] sm:text-3xl md:text-xl lg:text-2xl whitespace-nowrap leading-none text-yellow-100 transition-all duration-500 tracking-wide sm:tracking-widest ${expandedLetter === letter ? 'block md:block' : 'block md:hidden'} flex items-baseline gap-1`}
                  style={{ fontFamily: '"Times New Roman", serif' }}
                >
